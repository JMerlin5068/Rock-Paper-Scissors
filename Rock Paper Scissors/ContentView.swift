...
//  Rock Paper Scissors
//
//  Created by Jarrod Merlin on 2/14/24.
//
...
struct ContentView: View {
    ...
    @State private var options = ["Rock", "Paper","Scissors"] // rock paper scissors!
    ...
    var toWin: String {
        if options[computerNo] == "Rock" {
            return "Paper"
        } else if options[computerNo] == "Paper" {
            return "Scissors"
        } else {
            return "Rock"
